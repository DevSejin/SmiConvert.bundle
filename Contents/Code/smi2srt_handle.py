...
class SMI2SRTHandle(object):
    ...
    @staticmethod
    def start(work_path, remake=False, no_remove_smi=False, no_append_ko=False, no_change_ko_srt=False, fail_move_path=''):
        ...
        SMI2SRTHandle.result_list['option'] = {'work_path':work_path, 'remake':remake, 'no_remove_smi':no_remove_smi, 'no_append_ko':no_append_ko, 'no_change_ko_srt':no_change_ko_srt, 'fail_move_path':fail_move_path}
